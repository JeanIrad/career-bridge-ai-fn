          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="platform-name" defaultValue="CareerBridgeAI" />
              </div>
              <div className="space-y-2">
                <Label htmlFor="platform-description">Description</Label>
                <Textarea
                  id="platform-description"
                  defaultValue="AI-powered platform connecting students, alumni, employers, and universities"
                  rows={3}
                />
              </div>
              <div className="space-y-2">
                ...
                <Input
                  id="support-email"
                  defaultValue="support@careerbridgeai.com"
                />
              </div>
            </CardContent>
          </Card>
